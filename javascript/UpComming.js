...
fetch(url)
    ...
    .then(data => {
        ...
        let eventsFuture = filtrarFechas(data.events, data.currentDate, true)

        crearTarjetas(eventsFuture, carrusel)
        ...
        divCheckbox.addEventListener("change", e => {
            ...
            if (checked.length === 0) {
                ...
                newArray = filterCheckbox(eventsFuture, checked)
        ...
        search.addEventListener("keyup", e => {
            ...
            let newArray = filterCheckbox(eventsFuture, checked)

            let nuevoArregloBuscar = FitlerText(newArray, e.target.value)

            let buscador = FitlerText(eventsFuture, e.target.value)
